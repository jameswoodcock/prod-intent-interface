...
objectIDs = [[0],[1],[2],[3],[5],range(6,16),range(16,20),range(20,22),range(22,30),range(30,39),range(39,48),range(48,64)]          #mapping of objects
Nobjs = len(objectIDs)
...
class mySlider(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        object1_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[0])
        object2_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[1])
        object2_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[1])
        object3_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[2])
        object3_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[2])
        object4_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[3])
        object4_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[3])
        object5_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[4])
        object5_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[4])
        object6_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[5])
        object6_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[5])
        object7_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[6])
        object7_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[6])
        object8_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[7])
        object8_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[7])
        object9_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[8])
        object9_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[8])
        object10_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[9])
        object10_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[9])
        object11_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[10])
        object11_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[10])
        object12_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[11])
        object12_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[11])
        # object13_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[12])
        # object13_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[13])
        # object14_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[13])
        # object14_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[14])
        # object15_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[14])
        # object15_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal',value=object_pos[15])
        # object16_lev_slider = Slider(min=0, max=1,orientation='vertical',value=object_level[15])
        # object16_pos_slider = Slider(min=-pos_range, max=pos_range,orientation='horizontal')
        ...
        self.add_widget(Label(text='[b]Neil[/b]',markup = True))
        self.add_widget(Label(text='[b]Abby[/b]',markup = True))
        self.add_widget(Label(text='[b]Chant[/b]',markup = True))
        self.add_widget(Label(text='[b]Chants[/b]',markup = True))
        self.add_widget(Label(text='[b]Chants[/b]',markup = True))
        self.add_widget(Label(text='[b]Crowd[/b]',markup = True))
        self.add_widget(Label(text='[b]Crowd[/b]',markup = True))
        self.add_widget(Label(text='[b]LF rumble[/b]',markup = True))
        self.add_widget(Label(text='[b]Skyline[/b]',markup = True))
        self.add_widget(Label(text='[b]Crowd[/b]',markup = True))
        self.add_widget(Label(text='[b]Crowd FG[/b]',markup = True))
